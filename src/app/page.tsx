  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="container mx-auto px-4">
        {/* --- HERO SECTION --- */}
        <section className="pt-48 pb-24 md:pt-64 md:pb-32 flex flex-col items-center text-center">
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight max-w-4xl mb-6 flex flex-wrap justify-center items-center gap-x-2 md:gap-x-3 text-center">
              We make <TypewriterEffect words={[{ text: "evidence" }, { text: "evident.", className: "text-[#b8a5ff] font-serif italic font-medium drop-shadow-[0_0_15px_rgba(184,165,255,0.4)]" }]} />
            </h1>
        ...
        <section id="features" className="py-24 relative">
          ...
          <div className="text-center mb-16 relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Every tool you need, <br /><span className="font-serif italic text-primary drop-shadow-[0_0_15px_rgba(184,165,255,0.4)]">beautifully integrated.</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {/* Large Card 1 */}
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.5 }} className="md:col-span-2">
              <SpotlightCard className="flex flex-col justify-between min-h-[300px] border border-white/10 group bg-black/60">
                ...
                <div className="flex gap-2 flex-wrap mt-8">
                  {["School Evaluation Form", "Case Sampling", "Learning Walks", "Work Scrutiny", "Pupil Voice"].map(tool => (
            ...
            {/* Small Card 1 */}
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.5, delay: 0.1 }}>
            ...
            {/* Small Card 2 */}
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.5, delay: 0.2 }}>
            ...
            {/* Large Card 2 */}
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.5, delay: 0.3 }} className="md:col-span-2">
      ...
      <div className="container mx-auto px-4">
        ...
        <section id="how-it-works" className="py-24 border-t border-white/5 relative">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">From complex paperwork to clear <span className="font-serif italic text-primary">insight</span></h2>
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            {/* Step 1 */}
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6 }} className="flex flex-col md:flex-row items-start md:items-center gap-8 mb-16 relative">
            ...
            {/* Step 3 */}
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6 }} className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
              <div className="md:w-1/2 md:text-right md:pr-12 pl-16 md:pl-0 order-2 md:order-1">
        ...
        <section className="py-32 relative">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, type: "spring" }}>
